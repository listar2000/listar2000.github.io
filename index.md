...
My research focuses on developing and validating **principled frameworks** that leverage abundant, noisy signals — such as rewards, predictions, and environment feedback — to improve the **efficiency, reliability, and real-world performance** of language agents and decision-making systems. I work on problems that can be viewed from dual perspectives: 
...
Starting from March 2026, I will be joining [Snowflake AI Research](https://www.snowflake.com/en/product/ai/ai-research/) as a Research Intern (part-time), working on *post-training agentic systems*.
